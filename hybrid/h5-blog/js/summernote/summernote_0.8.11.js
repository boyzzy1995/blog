...
(function (global, factory) {
  ...
  let Renderer = /** @class */ (function () {
      ...
      Renderer.prototype.render = function ($parent) {
          ...
          if (this.children) {
              let $container_1 = $node.find('.note-children-container');
  ...
  let renderer = {
      create: function (markup, callback) {
          return function () {
              let options = typeof arguments[1] === 'object' ? arguments[1] : arguments[0];
              let children = $$1.isArray(arguments[0]) ? arguments[0] : [];
  ...
  let editor = renderer.create('<div class="note-editor note-frame panel panel-default"/>');
  let toolbar = renderer.create('<div class="note-toolbar panel-heading" role="toolbar"></div></div>');
  let editingArea = renderer.create('<div class="note-editing-area"/>');
  let codable = renderer.create('<textarea class="note-codable" role="textbox" aria-multiline="true"/>');
  let editable = renderer.create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>');
  let statusbar = renderer.create([
  ...
  let airEditor = renderer.create('<div class="note-editor"/>');
  let airEditable = renderer.create([
      '<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>',
      '<output class="note-status-output" aria-live="polite"/>'
  ].join(''));
  let buttonGroup = renderer.create('<div class="note-btn-group btn-group">');
  let dropdown = renderer.create('<ul class="dropdown-menu" role="list">', function ($node, options) {
      let markup = $$1.isArray(options.items) ? options.items.map(function (item) {
          let value = (typeof item === 'string') ? item : (item.value || '');
          let content = options.template ? options.template(item) : item;
          let option = (typeof item === 'object') ? item.option : undefined;
  ...
  let dropdownButtonContents = function (contents, options) {
      return contents + ' ' + icon(options.icons.caret, 'span');
  };
  let dropdownCheck = renderer.create('<ul class="dropdown-menu note-check" role="list">', function ($node, options) {
      let markup = $$1.isArray(options.items) ? options.items.map(function (item) {
          let value = (typeof item === 'string') ? item : (item.value || '');
          let content = options.template ? options.template(item) : item;
  ...
  let palette = renderer.create('<div class="note-color-palette"/>', function ($node, options) {
      let contents = [];
  ...
  let dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
      if (options.fade) {
          $node.addClass('fade');
      }
      $node.attr({
  ...
  let checkbox = renderer.create('<div class="checkbox"></div>', function ($node, options) {
      $node.html([
  ...
  var ui = {
      ...
      createLayout: function ($note, options) {
          let $editor = (options.airMode ? ui.airEditor([
              ui.editingArea([
                  ui.airEditable()
              ])
          ]) : ui.editor([
  ...
  function isFontInstalled(fontName) {
      ...
      let $tester = $$1('<div>').css({
          position: 'absolute',
          left: '-9999px',
          top: '-9999px',
          fontSize: '200px'
      }).text('mmmmmmmmmwwwwwww').appendTo(document.body);
      let originalWidth = $tester.css('fontFamily', testFontName).width();
      let width = $tester.css('fontFamily', fontName + ',' + testFontName).width();
      $tester.remove();
  ...
  let inputEventName = (isMSIE || isEdge) ? 'DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted' : 'input';
  /**
   * @class core.env
   *
  ...
  function walkPoint(startPoint, endPoint, handler, isSkipInnerOffset) {
      ...
      while (point) {
          ...
          let isSkipOffset = isSkipInnerOffset &&
  ...
  function html($node, isNewlineOnBlock) {
      ...
      if (isNewlineOnBlock) {
          ...
          markup = markup.replace(regexTag, function (match, endSlash, name) {
              ...
              let isEndOfInlineContainer = /^DIV|^TD|^TH|^P|^LI|^H[1-7]/.test(name) &&
                  !!endSlash;
  ...
  /**
     ...
     */
  let WrappedRange = /** @class */ (function () {
      ...
      WrappedRange.prototype.normalize = function () {
           ...
           * @return {BoundaryPoint}
           */
          let getVisiblePoint = function (point, isLeftToRight) {
              ...
              let nextPoint = isLeftToRight ? dom.nextPointUntil(dom.nextPoint(point), dom.isVisiblePoint)
      ...
      WrappedRange.prototype.nodes = function (pred, options) {
          ...
          let fullyContains = options && options.fullyContains;
      ...
      WrappedRange.prototype.insertNode = function (node) {
          let rng = this.wrapBodyInlineWithPara().deleteContents();
      ...
      WrappedRange.prototype.pasteHTML = function (markup) {
          let contentsContainer = $$1('<div></div>').html(markup)[0];
  ...
  let History = /** @class */ (function () {
      ...
      History.prototype.makeSnapshot = function () {
          ...
          let emptyBookmark = { s: { path: [], offset: 0 }, e: { path: [], offset: 0 } };
          return {
  ...
  let Style = /** @class */ (function () {
      ...
      Style.prototype.current = function (rng) {
          let $cont = $$1(!dom.isElement(rng.sc) ? rng.sc.parentNode : rng.sc);
          ...
          if (!rng.isOnList()) {
              ...
              let isUnordered = $$1.inArray(styleInfo['list-style-type'], orderedTypes) > -1;
  ...
  let Bullet = /** @class */ (function () {
      ...
      Bullet.prototype.indent = function (editable) {
          ...
          $$1.each(clustereds, function (idx, paras) {
              ...
              if (dom.isLi(head)) {
                  let previousList_1 = _this.findList(head.previousSibling);
                  if (previousList_1) {
                      paras
      ...
      Bullet.prototype.wrapList = function (paras, listName) {
          ...
          let listNode = prevList || dom.insertAfter(dom.create(listName || 'UL'), last);
          // P to LI
          ...
          $$1.each(clustereds, function (idx, paras) {
              ...
              if (headList.parentNode.nodeName === 'LI') {
                  paras.map(function (para) {
                      let newList = _this.findNextSiblings(para);
          ...
          if (splitRoot) {
              ...
              if (dom.isEmpty(splitRoot) && dom.isLi(splitRoot)) {
                  ...
                  if (blockquote) {
                      ...
                      let split = dom.splitTree(blockquote, rng.getStartPoint(), { isDiscardEmptySplits: true });
                      if (split) {
  ...
  var TableResultAction = function (startPoint, where, action, domTable) {
      let _startPoint = { 'colPos': 0, 'rowPos': 0 };
      let _virtualTable = [];
      let _actionCellList = [];
      /// ///////////////////////////////////////////
      // Private functions
  ...
  */
  ...
  let Table = /** @class */ (function () {
      ...
      Table.prototype.addRow = function (rng, position) {
          let cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
          let currentTr = $$1(cell).closest('tr');
          let trAttributes = this.recoverAttributes(currentTr);
          let html = $$1('<tr' + trAttributes + '></tr>');
          let vTable = new TableResultAction(cell, TableResultAction.where.Row, TableResultAction.requestAction.Add, $$1(currentTr).closest('table')[0]);
              ...
              switch (currentCell.action) {
                  ...
                  case TableResultAction.resultAction.SumSpanCount:
                      if (position === 'top') {
                          ...
                          if (isTopFromRowSpan) {
                              let newTd = $$1('<div></div>').append($$1('<td' + tdAttributes + '>' + dom.blank + '</td>').removeAttr('rowspan')).html();
                              html.append(newTd);
                              break;
                          }
                      }
      ...
      Table.prototype.addCol = function (rng, position) {
          let cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
          let row = $$1(cell).closest('tr');
          let rowsGroup = $$1(row).siblings();
          rowsGroup.push(row);
          let vTable = new TableResultAction(cell, TableResultAction.where.Column, TableResultAction.requestAction.Add, $$1(row).closest('table')[0]);
          let actions = vTable.getActionList();
      ...
      */
      ...
      Table.prototype.deleteRow = function (rng) {
          let cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
          let row = $$1(cell).closest('tr');
          let cellPos = row.children('td, th').index($$1(cell));
          let rowPos = row[0].rowIndex;
          let vTable = new TableResultAction(cell, TableResultAction.where.Row, TableResultAction.requestAction.Delete, $$1(row).closest('table')[0]);
          let actions = vTable.getActionList();
          for (let actionIndex = 0; actionIndex < actions.length; actionIndex++) {
      ...
      Table.prototype.deleteCol = function (rng) {
          ...
          let row = $$1(cell).closest('tr');
          let cellPos = row.children('td, th').index($$1(cell));
          let vTable = new TableResultAction(cell, TableResultAction.where.Column, TableResultAction.requestAction.Delete, $$1(row).closest('table')[0]);
          let actions = vTable.getActionList();
          for (let actionIndex = 0; actionIndex < actions.length; actionIndex++) {
              if (!actions[actionIndex]) {
                  continue;
      ...
      Table.prototype.createTable = function (colCount, rowCount, options) {
          ...
          trHTML = trs.join('');
          let $table = $$1('<table>' + trHTML + '</table>');
  ...
  let Editor = /** @class */ (function () {
      function Editor(context) {
          ...
          this.pasteHTML = this.wrapCommand(function (markup) {
              ...
              let contents = _this.createRange().pasteHTML(markup);
          ...
          this.createLink = this.wrapCommand(function (linkInfo) {
              ...
              let rng = linkInfo.range || _this.createRange();
              let additionalTextLength = linkText.length - rng.toString().length;
              if (additionalTextLength > 0 && _this.isLimited(additionalTextLength)) {
                  return;
              }
              let isTextChanged = rng.toString() !== linkText;
              ...
              if (isTextChanged) {
                  rng = rng.deleteContents();
                  let anchor = rng.insertNode($$1('<A>' + linkText + '</A>')[0]);
                  anchors.push(anchor);
              }
              else {
              ...
              let startRange = range.createFromNodeBefore(lists.head(anchors));
              let startPoint = startRange.getStartPoint();
              let endRange = range.createFromNodeAfter(lists.last(anchors));
          ...
          this.insertTable = this.wrapCommand(function (dim) {
              ...
              let rng = _this.createRange().deleteContents();
          ...
          this.removeMedia = this.wrapCommand(function () {
              let $target = $$1(_this.restoreTarget()).parent();
          ...
          this.floatMe = this.wrapCommand(function (value) {
              let $target = $$1(_this.restoreTarget());
      ...
      */
      ...
      Editor.prototype.onFormatBlock = function (tagName, $target) {
          ...
          if ($target && $target.length) {
              ...
              if (className) {
                  ...
                  let $parent = $$1([currentRange.sc, currentRange.ec]).closest(tagName);
      ...
      Editor.prototype.getLinkInfo = function () {
          ...
          let $anchor = $$1(lists.head(rng.nodes(dom.isAnchor)));
          let linkInfo = {
              range: rng,
              text: rng.toString(),
      ...
      Editor.prototype.addRow = function (position) {
          let rng = this.createRange(this.$editable);
          if (rng.isCollapsed() && rng.isOnCell()) {
              this.beforeCommand();
  ...
  let CodeView = /** @class */ (function () {
      ...
      CodeView.prototype.activate = function () {
          ...
          if (env.hasCodeMirror) {
              let cmEditor_1 = CodeMirror.fromTextArea(this.$codable[0], this.options.codemirror);
              // CodeMirror TernServer
              if (this.options.codemirror.tern) {
                  let server_1 = new CodeMirror.TernServer(this.options.codemirror.tern);
      ...
      Handle.prototype.initialize = function () {
          ...
          this.$handle.on('mousedown', function (event) {
              if (dom.isControlSizing(event.target)) {
                  event.preventDefault();
                  event.stopPropagation();
                  let $target_1 = _this.$handle.find('.note-control-selection').data('target');
                  let posStart_1 = $target_1.offset();
                  let scrollTop_1 = _this.$document.scrollTop();
                  let onMouseMove_1 = function (event) {
  ...
  let linkPattern = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i;
  let AutoLink = /** @class */ (function () {
      ...
      AutoLink.prototype.replace = function () {
          ...
          if (match && (match[1] || match[2])) {
              ...
              let node = $$1('<a />').html(keyword).attr('href', link)[0];
  ...
  let Placeholder = /** @class */ (function () {
  ...
  let Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.isFontDeservedToAdd = function (name) {
          let genericFamilies = ['sans-serif', 'serif', 'monospace', 'cursive', 'fantasy'];
              ...
              children: [
                  ...
                  this.ui.dropdown({
                      ...
                      callback: function ($dropdown) {
                          ...
                          $dropdown.find('input[type=color]').each(function (idx, item) {
                              $$1(item).change(function () {
                                  let $chip = $dropdown.find('#' + $$1(this).data('event')).find('.note-color-btn').first();
                      ...
                      click: function (event) {
                          event.stopPropagation();
                          let $parent = $$1('.' + className);
                          let $button = $$1(event.target);
                          let eventName = $button.data('event');
                          let value = $button.attr('data-value');
                          if (eventName === 'openPalette') {
                              let $picker = $parent.find('#' + value);
                              let $palette = $$1($parent.find('#' + $picker.data('event')).find('.note-color-row')[0]);
                              // Shift palette chips
                              let $chip = $palette.find('.note-color-btn').last().detach();
                              // Set chip attributes
      ...
      Buttons.prototype.addToolbarButtons = function () {
          ...
          let _loop_1 = function (styleIdx, styleLen) {
              let item = this_1.options.styleTags[styleIdx];
          ...
          this.context.memo('button.fontname', function () {
              let styleInfo = _this.context.invoke('editor.currentStyle');
      ...
      Buttons.prototype.build = function ($container, groups) {
          for (let groupIdx = 0, groupLen = groups.length; groupIdx < groupLen; groupIdx++) {
              ...
              let groupName = $$1.isArray(group) ? group[0] : group;
              let buttons = $$1.isArray(group) ? ((group.length === 1) ? [group[0]] : group[1]) : [group];
      ...
      Buttons.prototype.updateCurrentStyle = function ($container) {
          ...
          if (styleInfo['font-family']) {
              ...
              let fontName_1 = lists.find(fontNames, this.isFontInstalled.bind(this));
              $cont.find('.dropdown-fontname a').each(function (idx, item) {
                  let $item = $$1(item);
                  // always compare string to avoid creating another func.
                  let isChecked = ($item.data('value') + '') === (fontName_1 + '');
                  $item.toggleClass('checked', isChecked);
              });
              $cont.find('.note-current-fontname').text(fontName_1).css('font-family', fontName_1);
          }
          if (styleInfo['font-size']) {
              let fontSize_1 = styleInfo['font-size'];
              $cont.find('.dropdown-fontsize a').each(function (idx, item) {
                  let $item = $$1(item);
                  // always compare with string to avoid creating another func.
                  let isChecked = ($item.data('value') + '') === (fontSize_1 + '');
                  $item.toggleClass('checked', isChecked);
              });
              $cont.find('.note-current-fontsize').text(fontSize_1);
          }
          if (styleInfo['line-height']) {
              let lineHeight_1 = styleInfo['line-height'];
              $cont.find('.dropdown-line-height li a').each(function (idx, item) {
                  // always compare with string to avoid creating another func.
                  let isChecked = ($$1(item).data('value') + '') === (lineHeight_1 + '');
      ...
      Buttons.prototype.tableMoveHandler = function (event) {
          let PX_PER_EM = 18;
          let $picker = $$1(event.target.parentNode); // target is mousecatcher
          ...
          if (event.offsetX === undefined) {
              let posCatcher = $$1(event.target).offset();
              posOffset = {
  ...
  let Toolbar = /** @class */ (function () {
      ...
      Toolbar.prototype.followScroll = function () {
          ...
          let $toolbarWrapper = this.$toolbar.parent('.note-toolbar-wrapper');
          ...
          let deactivateOffsetBottom = editorOffsetBottom - otherBarHeight - toolbarHeight;
  ...
  let LinkDialog = /** @class */ (function () {
      ...
      LinkDialog.prototype.initialize = function () {
          ...
          let footer = '<input type="button" href="#" class="' + buttonClass + '" value="' + this.lang.link.insert + '" disabled>';
      ...
      LinkDialog.prototype.showLinkDialog = function (linkInfo) {
          ...
          return $$1.Deferred(function (deferred) {
              ...
              let $openInNewWindow = _this.$dialog
              ...
              _this.ui.onDialogShown(_this.$dialog, function () {
                  ...
                  let handleLinkTextUpdate = function () {
                  ...
                  let handleLinkUrlUpdate = function () {
                      _this.toggleLinkBtn($linkBtn, $linkText, $linkUrl);
                  ...
                  let isNewWindowChecked = linkInfo.isNewWindow !== undefined
  ...
  let LinkPopover = /** @class */ (function () {
  ...
  let ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          if (this.options.maximumImageFileSize) {
              ...
              let readableSize = (this.options.maximumImageFileSize / Math.pow(1024, unit)).toFixed(2) * 1 +
                  ' ' + ' KMGTP'[unit] + 'B';
          ...
          let footer = '<input type="button" href="#" class="' + buttonClass + '" value="' + this.lang.image.insert + '" disabled>';
          this.$dialog = this.ui.dialog({
      ...
      ImageDialog.prototype.showImageDialog = function () {
          let _this = this;
          return $$1.Deferred(function (deferred) {
              let $imageInput = _this.$dialog.find('.note-image-input');
              let $imageUrl = _this.$dialog.find('.note-image-url');
              let $imageBtn = _this.$dialog.find('.note-image-btn');
              _this.ui.onDialogShown(_this.$dialog, function () {
                  _this.context.triggerEvent('dialog.shown');
   ...
   */
  let ImagePopover = /** @class */ (function () {
      ...
      ImagePopover.prototype.update = function (target) {
          if (dom.isImg(target)) {
              ...
              let posEditor = dom.posFromPlaceholder(this.editable);
              this.$popover.css({
                  display: 'block',
  ...
  let TablePopover = /** @class */ (function () {
  ...
  let VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.initialize = function () {
          ...
          let footer = '<input type="button" href="#" class="' + buttonClass + '" value="' + this.lang.video.insert + '" disabled>';
          this.$dialog = this.ui.dialog({
      ...
      VideoDialog.prototype.showVideoDialog = function (text) {
          let _this = this;
          return $$1.Deferred(function (deferred) {
              let $videoUrl = _this.$dialog.find('.note-video-url');
              let $videoBtn = _this.$dialog.find('.note-video-btn');
              _this.ui.onDialogShown(_this.$dialog, function () {
                  _this.context.triggerEvent('dialog.shown');
  ...
  let HelpDialog = /** @class */ (function () {
      ...
      HelpDialog.prototype.createShortcutList = function () {
          ...
          return Object.keys(keyMap).map(function (key) {
              ...
              let $row = $$1('<div><div class="help-list-item"/></div>');
  ...
  let AIR_MODE_POPOVER_X_OFFSET = 20;
  let AirPopover = /** @class */ (function () {
      ...
      AirPopover.prototype.update = function () {
          ...
          if (styleInfo.range && !styleInfo.range.isCollapsed()) {
              let rect = lists.last(styleInfo.range.getClientRects());
              if (rect) {
                  let bnd = func.rect2bnd(rect);
                  this.$popover.css({
                      display: 'block',
  ...
  let POPOVER_DIST = 5;
  let HintPopover = /** @class */ (function () {
      ...
      HintPopover.prototype.replace = function () {
          ...
          if ($item.length) {
              let node = this.nodeFromItem($item);
      ...
      HintPopover.prototype.createItemTemplates = function (hintIdx, items) {
          ...
          return items.map(function (item, idx) {
              let $item = $$1('<div class="note-hint-item"/>');
      ...
      HintPopover.prototype.createGroup = function (idx, keyword) {
          let _this = this;
          let $group = $$1('<div class="note-hint-group note-hint-group-' + idx + '"/>');
      ...
      HintPopover.prototype.handleKeyup = function (e) {
          ...
          if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
              let wordRange = this.context.invoke('editor.createRange').getWordRange();
              let keyword_1 = wordRange.toString();
  ...
  let Context = /** @class */ (function () {
      ...
      Context.prototype._initialize = function () {
          ...
          let buttons = $$1.extend({}, this.options.buttons);
          Object.keys(buttons).forEach(function (key) {
              _this.memo('button.' + key, buttons[key]);
          });
          let modules = $$1.extend({}, this.options.modules, $$1.summernote.plugins || {});
  ...
  $$1.fn.extend({
       ...
       */
      summernote: function () {
          let type = $$1.type(lists.head(arguments));
          let isExternalAPICalled = type === 'string';
          let hasInitOptions = type === 'object';
          let options = $$1.extend({}, $$1.summernote.options, hasInitOptions ? lists.head(arguments) : {});
          // Update options
